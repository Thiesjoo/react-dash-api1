        ...
        if (body.email && body.password && body.firstname && body.lastname) {
            if (security.emailRegex.test(body.email) && security.passwordRegex.test(body.password)) {
                ...
                if (user) {
                    ...
                    var newUser = await setUser(body.email, body.firstname, body.lastname, hash, refreshArray, { emailVerified: false }, [{id: 0, priority: 3, title: "This is your first todo", message: "You should delete this todo"}])
